...
verify.completionsAt("0", ["someFile.ts", "sub", "my_typings"]);
verify.completionsAt("1", ["some-module"]);
verify.completionsAt("2", ["someOtherFile.ts"]);
verify.completionsAt("3", ["some-module"]);
